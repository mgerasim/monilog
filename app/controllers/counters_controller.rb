class CountersController < ApplicationController
  ...
  def new
    ...
    @counter = Counter.new
    @counter.site = Site.find_by_id(params[:site_id])
...
#        format.html { redirect_to @counter, notice: 'Counter was successfully created.' }
	...
	format.html { redirect_to site_counter_path(@counter.site, @counter), notice: 'Counter was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      format.html { redirect_to site_path(site), notice: 'Counter was successfully deleted.' }
